...
//   // const [restaurant, setRestaurant] = useState(decoded);
//   // const [driver, setDriver] = useState(decoded);
...
//   //     .then(response => {
//   //       const foods = response.data.data.filter(
//   //         (appointment) => appointment.restaurant === restaurant._id 
//   //         && restaurant.employees === user._id
//   //       );
//   //       setfoods(foods);
//   //     })
//   //     .catch(error => {
...
//   // axios.post(APPOINTMENT_URL, newfood)
//   // .then((response) => {
//   //   const addedFood = response.data.data;
//   //   setfoods([...foods, addedFood]);
//   //   setAddFormData({ food: "",foodQuantity: 0.0, unit: "",});
...
//     // axios
//     //   .put(USER_URL + editedfood._id, editedfood, {
//     //     headers: {
//     //       Authorization: "Bearer " + localStorage.getItem("token"),
//     //     },
//     //   })
//     //   .then((response) => {
//     //     const editedfood = response.data.data;

//     //     newfoods = foods.map((food) =>
//     //       food._id === editedfood._id ? editedfood : food
//     //     );
//     //   });
